...
function setup() {
  ...
  for(let i = 0; i < mushCount; i++)
    {
      mushrooms.push(new Mushroom(random(50,width-50), random(50,height-50), 30, mushSprite))
    }
  allObjectsToUpdate.push(mushrooms);

  for(let i = 0; i < frogCount; i++)
  {
    frogs.push(new Frog(random(50,width-50), random(50,height-50), 20, frogSprite))
  }
